...
import { editAllCategory } from "../store/productSlice";

export default function EditCategory({ onClose, dataCategoryId }) {
  console.log("edit", dataCategoryId);
  const [data, setData] = useState({
    categoryId: dataCategoryId._id,
    name: dataCategoryId.name,
    image: dataCategoryId.image,
  });
